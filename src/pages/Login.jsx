          ...
          <div className="bg-gray-100 w-full backdrop-blur-3xl h-full bg-opacity-30">
            <div className="w-full h-full flex justify-center items-center">
              <div className="max-w-md mx-auto bg-white bg-opacity-10 border-2 border-gray-500 border-opacity-30 drop-shadow-xl shadow-xl w-full p-5 rounded-md py-10 space-y-3 md:space-y-5">
                <h1 className="text-center text-4xl font-bold text-gray-950">Flavas-of-chill</h1>
                ...
                <form className="space-y-4 md:space-y-6" action="#">
                  <div>
                    ...
                    <input
                      ...
                      className="bg-transparent outline-none border focus:ring-1 border-gray-500 border-opacity-30 text-gray-900 placeholder:text-gray-700 sm:text-sm rounded-lg focus:ring-gray-350 focus:border-gray-350 block w-full p-2.5" required />
                  </div>
                  <div>
                  ...
                  <Link to={'/'}>
                    <button type="button" className="w-full text-white bg-gray-350 hover:bg-gray-800 focus:ring-1 focus:outline-none focus:ring-gray-250 font-semibold rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
                  </Link>
                  {/* {loading ?
